...
func init() {
	...
	AwsxKmsListCmd.PersistentFlags().String("functionName", "", "lambda function name")
	AwsxKmsListCmd.PersistentFlags().String("bucketName", "", "s3 bucket name")
	AwsxKmsListCmd.PersistentFlags().String("arn", "", "arn")
