...
func init() {
	...
	AwsxEcsConfigCmd.PersistentFlags().String("apiKey", "", "api gateway key/id")
	...
	AwsxEcsConfigCmd.PersistentFlags().String("streamName", "", "kinesis stream name")
	AwsxEcsConfigCmd.PersistentFlags().String("keyId", "", "kms key id")
	AwsxEcsConfigCmd.PersistentFlags().String("functionName", "", "lambda function name")
	AwsxEcsConfigCmd.PersistentFlags().String("bucketName", "", "s3 bucket name")
	AwsxEcsConfigCmd.PersistentFlags().String("arn", "", "arn")
