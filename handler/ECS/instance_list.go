...
func init() {
	...
	AwsxEcsListCmd.PersistentFlags().String("apiKey", "", "api gateway key/id")
	...
	AwsxEcsListCmd.PersistentFlags().String("streamName", "", "kinesis stream name")
	AwsxEcsListCmd.PersistentFlags().String("keyId", "", "kms key id")
	AwsxEcsListCmd.PersistentFlags().String("functionName", "", "lambda function name")
	AwsxEcsListCmd.PersistentFlags().String("bucketName", "", "s3 bucket name")
	AwsxEcsListCmd.PersistentFlags().String("arn", "", "arn")
