...
func init() {
	...
	AwsxCdnFunctionListCmd.PersistentFlags().String("apiKey", "", "api gateway key/id")
	...
	AwsxCdnFunctionListCmd.PersistentFlags().String("streamName", "", "kinesis stream name")
	AwsxCdnFunctionListCmd.PersistentFlags().String("keyId", "", "kms key id")
	AwsxCdnFunctionListCmd.PersistentFlags().String("functionName", "", "lambda function name")
	AwsxCdnFunctionListCmd.PersistentFlags().String("bucketName", "", "s3 bucket name")
	AwsxCdnFunctionListCmd.PersistentFlags().String("arn", "", "arn")
