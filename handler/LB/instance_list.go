...
func init() {
	...
	AwsxLbListCmd.PersistentFlags().String("streamName", "", "kinesis stream name")
	AwsxLbListCmd.PersistentFlags().String("keyId", "", "kms key id")
	AwsxLbListCmd.PersistentFlags().String("functionName", "", "lambda function name")
	AwsxLbListCmd.PersistentFlags().String("bucketName", "", "s3 bucket name")
	AwsxLbListCmd.PersistentFlags().String("arn", "", "arn")
