...
import (
	"awsx-getlandingzonedetails/handler/API_GW"
	"awsx-getlandingzonedetails/handler/CDN"
	"awsx-getlandingzonedetails/handler/CONFIG_SERVICE"
	"awsx-getlandingzonedetails/handler/DYNAMODB"
	"awsx-getlandingzonedetails/handler/EC2"
	"awsx-getlandingzonedetails/handler/ECS"
	"awsx-getlandingzonedetails/handler/EKS"
	"awsx-getlandingzonedetails/handler/KINESIS"
	"awsx-getlandingzonedetails/handler/KMS"
	"awsx-getlandingzonedetails/handler/LAMBDA"
